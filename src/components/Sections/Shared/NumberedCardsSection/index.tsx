...
export interface NumberedCardsSectionProps {
...
export function NumberedCardsSection({
  title,
  subtitle,
  cards,
}: Readonly<NumberedCardsSectionProps>) {
  // Validação: mínimo 2 cards, máximo 9
  if (cards.length < 2 || cards.length > 9) {
    console.warn('NumberedCardsSection: cards deve ter entre 2 e 9 itens')
  }
